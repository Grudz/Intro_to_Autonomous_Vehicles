...
int main(int argc, char** argv){
    ...
    ros::Subscriber sub_twist = nh.subscribe("cmd_vel", 1, recvTwist); // name, buffer, callback
    left_wheel_pub = nh.advertise<std_msgs::Float64>("/roundbot/left_speed_cmd",1); // referring to the publisher above
